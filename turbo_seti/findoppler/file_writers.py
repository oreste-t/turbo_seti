...
class GeneralWriter:
    ...
    def __init__(self, filename='', mode='a'):
        ...
        object, sets the new object's filename to the file's name.
    ...
    def write(self, info_str, mode='a'):
        """
        Sets file mode to a writeable mode, opens it, writes info_str to it, and then closes it.
        Due to how open is implemented, the second if-statement in this function will always run.
